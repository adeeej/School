...
namespace structures
{
	...
	Structure& Array<T>::assign(Structure& other)
	{
		...
		// pretypujte other na pole
		// skontrolujte velkost
		// ak je rovnaka velkost, tak priradte vektory, ktore patria poliam (assign)
	...
	{
		// pretypujte si other a ukazovatel na pole
		// bolo to pole?
	...
	{
		// ziskajte pomocou mapovacej funkcie index vo vektore
		// ziskajte ukazovatel na byte vo vektore na indexe z kroku 1
		// pretypujte ukazovatel z kroku 2 na ukazovatel  na T (T*)
		// vratte to, na co ukazovatel z kroku 3 ukazuje (dereferujte pointer)
