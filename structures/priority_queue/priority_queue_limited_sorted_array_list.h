...
namespace structures
{
    ...
    {
        PriorityQueueLimitedSortedArrayList<T>& otherPriorityQueueLimitedSortedList = dynamic_cast<PriorityQueueLimitedSortedArrayList<T>&>(other);
        this->capacity_ = otherPriorityQueueLimitedSortedList.capacity_;
        return PriorityQueueSortedArrayList<T>::assign(otherPriorityQueueLimitedSortedList);
    }
    ...
    void PriorityQueueLimitedSortedArrayList<T>::push(int priority, const T& data)
    {
        ...
        {
            //vynimka
            throw std::logic_error("PriorityQueueLimitedSortedList is full");
        }
    ...
    inline int PriorityQueueLimitedSortedArrayList<T>::minPriority()
    {
        ...
        throw std::logic_error("PriorityQueueLimitedSortedList is empty");
    }
