...
namespace structures
{
	...
	inline ArrayList<T>::ArrayList() :
		List<T>(),		//volanie bezparam konstruktora predka, nemusi byt
	...
	inline Structure& ArrayList<T>::assign(Structure& other)
	{
		...
		//pretypovat
		//zahodit pole(array)
		//vytvorte nove pole kopirovacim konstruktorom z other pola a priradte do array_
		//priradit size_
		if (this != &other)
		{
	...
	{
		Array<T>* biggerArray = new Array<T>(2 * array_->size());
