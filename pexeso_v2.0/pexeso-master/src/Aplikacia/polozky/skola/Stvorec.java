package Aplikacia.polozky.skola;

import Aplikacia.polozky.Stavy;
import java.awt.Rectangle;
/**
 * Trieda Stvorec je z cviceni.
 */
/**
...
public class Stvorec {
    ...
    private Stavy stavStvorca;
    //private StavyObrazka stavStvorca;
    ...
    public void skry() {
        this.zmaz();
        this.jeViditelny = false;
        this.setStavStvorca(Stavy.ZMAZANY);
    }
    ...
    public boolean obsahujeBod(int x, int y) {
        if ((x < this.lavyHornyX || x > this.lavyHornyX + this.strana) || (y < this.lavyHornyY || y > this.lavyHornyY + this.strana))
            return false;

        return true;
    }

    public void setStavStvorca(Stavy stavStvorca){
        this.stavStvorca = stavStvorca;
    }
}
