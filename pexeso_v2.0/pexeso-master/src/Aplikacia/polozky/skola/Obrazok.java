   ...
   // }
    ...
    private void nakresli() {
       if (this.jeViditelny) {
            ...
            at.translate(this.lavyHornyX + 1 / 2, lavyHornyY + 1 / 2);
            at.rotate(this.uhol / 180.0 * Math.PI);
            at.translate(-1 / 2, -1 / 2);
    ...
    public boolean obsahujeBod(int x, int y) {
        if (x < this.lavyHornyX || x > this.lavyHornyX )
            return false;

        if (y < this.lavyHornyY || y > this.lavyHornyY )
            return false;
